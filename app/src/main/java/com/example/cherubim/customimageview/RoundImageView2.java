...
/**
 * Created by cherubim on 2018/6/25.
 */
...
public class RoundImageView2 extends android.support.v7.widget.AppCompatImageView {
    ...
    public RoundImageView2(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        type = a.getInt(R.styleable.RoundImageView2_type, TYPE_OVAL);

        mBorderColor = a.getColor(R.styleable.RoundImageView2_border_color, Color.WHITE);

        mBorderWidth = a.getDimension(R.styleable.RoundImageView2_border_width, 0);

        mCornerRadius = a.getDimension(R.styleable.RoundImageView2_corner_radius, dp2px(10));

        mLeftTopCornerRadius = a.getDimension(R.styleable.RoundImageView2_leftTop_corner_radius, 0);

        mLeftBottomCornerRadius = a.getDimension(R.styleable.RoundImageView2_leftBottom_corner_radius, 0);

        mRightTopCornerRadius = a.getDimension(R.styleable.RoundImageView2_rightTop_corner_radius, 0);

        mRightBottomCornerRadius = a.getDimension(R.styleable.RoundImageView2_rightBottom_corner_radius, 0);
    ...
    public RoundImageView2 setType(int imageType) {
    ...
    public RoundImageView2 setCornerRadius(int cornerRadius) {
    ...
    public RoundImageView2 setLeftTopCornerRadius(int cornerRadius) {
    ...
    public RoundImageView2 setRightTopCornerRadius(int cornerRadius) {
    ...
    public RoundImageView2 setLeftBottomCornerRadius(int cornerRadius) {
    ...
    public RoundImageView2 setRightBottomCornerRadius(int cornerRadius) {
    ...
    public RoundImageView2 setBorderWidth(int borderWidth) {
    ...
    public RoundImageView2 setBorderColor(int borderColor) {
